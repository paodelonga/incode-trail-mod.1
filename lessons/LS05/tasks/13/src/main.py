...
if per_deseja_pedido == "sim":
    ...
    if per_outro_principal == "sim":
        ...
        qtd_outro_principal = int(
            input(f"Qual a quantidade de pratos Nº{outro_principal}? ")
        )
    ...
    if per_pedido_acomp == "sim":
        ...
        qtd_acomp_principal = int(
            input(f"Qual a quantidade do acompanhamento Nº{acomp_principal}? ")
        )
        ...
        if per_outro_acomp == "sim":
            ...
            qtd_outro_acomp = int(
                input(f"Qual a quantidade do acompanhamento Nº{outro_acomp}? ")
            )
